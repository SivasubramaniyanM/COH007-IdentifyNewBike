...
public class TC_23InvalidGoogleLogin extends BaseTest {
    ...
    public void verifyInvalidGoogleLogin() throws Exception {
        ...
        wait.until(driver -> {
            try {
                String txt = driver.findElement(By.id("headingText"))
                        .getText().toLowerCase();
        ...
        wait.until(
                ExpectedConditions.elementToBeClickable(
                        By.xpath("//span[contains(text(),'Try')]"))
        );
        ...
        Assert.assertTrue(
                errorHeading.toLowerCase().contains("couldn")
                        || errorHeading.toLowerCase().contains("sign you in"),
                "Expected error message not displayed. Actual : " + errorHeading
        );
