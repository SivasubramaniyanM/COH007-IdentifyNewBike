...
public class TC_14PopularModels extends BaseTest {
    ...
    public void verifyPopularModels() throws Exception {
        ...
        softAssert.assertEquals(driver.getCurrentUrl(), locationurl, "Failed to navigate to Chennai Used Cars page");
        ...
        softAssert.assertFalse(popularModelsList.isEmpty(), "Popular Models list is empty");
        // Soft check — At least one model found
        softAssert.assertTrue(popularModelsList.size() > 0, "Popular Models count is 0");
